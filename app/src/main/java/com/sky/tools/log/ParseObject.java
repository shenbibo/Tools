...
import com.sky.tools.log.parse.ArrayParser;
import com.sky.tools.log.parse.BundleParser;
import com.sky.tools.log.parse.CollectionParser;
import com.sky.tools.log.parse.IntentParser;
...
public final class ParseObject {
    ...
    static void addObjectParser(Parser parserAdapter) {
        ...
        synchronized (ParseObject.class) {
            ...
            OBJECT_PARSERS.add(parserAdapter);
        }
    }
