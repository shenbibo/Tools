...
final class Timber {
    ...
    public static void v(String tag, String compoundMsg, @Nullable String normalMsg, @Nullable Object... args) {
        SOULS_TREE.v(tag, compoundMsg, normalMsg, args);
    }

    public static void d(String tag, String compoundMsg, @Nullable String normalMsg, @Nullable Object... args) {
        SOULS_TREE.d(tag, compoundMsg, normalMsg, args);
    }
    ...
    public static void i(String tag, String compoundMsg, @Nullable String normalMsg, @Nullable Object... args) {
        SOULS_TREE.i(tag, compoundMsg, normalMsg, args);
    }

    public static void w(String tag, String compoundMsg, @Nullable String normalMsg, @Nullable Object... args) {
        SOULS_TREE.w(tag, compoundMsg, normalMsg, args);
    }
    ...
    public static void e(String tag, String compoundMsg, @Nullable String normalMsg, @Nullable Object... args) {
        SOULS_TREE.e(tag, compoundMsg, normalMsg, args);
    }
    ...
    public static void wtf(String tag, String compoundMsg, @Nullable String normalMsg, @Nullable Object... args) {
        SOULS_TREE.wtf(tag, compoundMsg, normalMsg, args);
    }

    public static void log(int priority, String tag, Throwable t, String compoundMsg, @Nullable String normalMsg,
            @Nullable Object... args) {
        SOULS_TREE.log(priority, tag, t, compoundMsg, normalMsg, args);
    }
    ...
    private static final AbsTree SOULS_TREE = new AbsTree() {
        ...
        public void v(String tag, String compoundMsg, @Nullable String normalMsg, @Nullable Object... args) {
            ...
            for (int i = 0, count = forest.length; i < count; i++) {
                forest[i].v(tag, compoundMsg, normalMsg, args);
            }
        }
        ...
        public void d(String tag, String compoundMsg, @Nullable String normalMsg, @Nullable Object... args) {
            ...
            //noinspection ForLoopReplaceableByForEach
            for (int i = 0, count = forest.length; i < count; i++) {
                forest[i].d(tag, compoundMsg, normalMsg, args);
            }
        }
        ...
        public void i(String tag, String compoundMsg, @Nullable String normalMsg, @Nullable Object... args) {
            ...
            //noinspection ForLoopReplaceableByForEach
            for (int i = 0, count = forest.length; i < count; i++) {
                forest[i].i(tag, compoundMsg, normalMsg, args);
            }
        }
        ...
        public void w(String tag, String compoundMsg, @Nullable String normalMsg, @Nullable Object... args) {
            ...
            //noinspection ForLoopReplaceableByForEach
            for (int i = 0, count = forest.length; i < count; i++) {
                forest[i].w(tag, compoundMsg, normalMsg, args);
            }
        }
        ...
        public void e(String tag, String compoundMsg, @Nullable String normalMsg, @Nullable Object... args) {
            ...
            //noinspection ForLoopReplaceableByForEach
            for (int i = 0, count = forest.length; i < count; i++) {
                forest[i].e(tag, compoundMsg, normalMsg, args);
            }
        }
        ...
        public void wtf(String tag, String compoundMsg, @Nullable String normalMsg, @Nullable Object... args) {
            ...
            //noinspection ForLoopReplaceableByForEach
            for (int i = 0, count = forest.length; i < count; i++) {
                forest[i].wtf(tag, compoundMsg, normalMsg, args);
            }
        }
        ...
        public void log(int priority, String tag, Throwable t, String compoundMsg, @Nullable String normalMsg,
            ...
            //noinspection ForLoopReplaceableByForEach
            for (int i = 0, count = forest.length; i < count; i++) {
                forest[i].log(priority, tag, t, compoundMsg, normalMsg, args);
            }
        }
