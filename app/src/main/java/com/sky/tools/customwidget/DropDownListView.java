package com.sky.tools.customwidget;
...
public class DropDownListView extends ListView implements OnScrollListener {
    ...
    private void initDropDownStyle() {
        ...
        headerLayout = (RelativeLayout)inflater.inflate(R.layout.drop_down_listview_header, this, false);
    ...
    private void initOnBottomStyle() {
        ...
        LayoutInflater inflater = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        footerLayout = (RelativeLayout)inflater.inflate(R.layout.drop_down_listview_footer, this, false);
